...
namespace MoviesAPI.Helpers
{
    public class TypeBinder<T> : IModelBinder
    {
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            // if there is no value, there is nothing we have to bind, else we will deserialize the value
            ...
            else
            {
                try
                {
            // we are deserialising object to a type the model gets to decide, thats why we are using generics<T>
