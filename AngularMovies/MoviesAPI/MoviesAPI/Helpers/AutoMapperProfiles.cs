    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<MovieCreationDTO, Movie>()
                // we want to ignore the poster property because we will handle that by ourselves
        ...
        private List<GenreDTO> MapMoviesGenres(Movie movie, MovieDTO moviedto)
        {
            ...
            if (movie.MoviesGenres != null)
            {
                ...
                {
                    //only by usign theninclude we have access to the genre.Genre.Name, zato u 
                    // moviescontrolleru kog get metode koristiš theninclude
        ...
        private List<MoviesGenres> MapMoviesGenres(MovieCreationDTO movieCreationDTO, Movie movie)
        {
            ...
            // if there are no genresid here, there is nothign for us to do
